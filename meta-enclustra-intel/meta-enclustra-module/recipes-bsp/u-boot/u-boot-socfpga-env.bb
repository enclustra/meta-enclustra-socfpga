...
SRC_URI:append:aa1-module = " file://sdmmc_u-boot-env.txt file://qspi_u-boot-env.txt"
...
#    mkenvimage -s 0x80000 -o "${WORKDIR}/uboot.env" ${WORKDIR}/${UBOOT_CONFIG}_u-boot-env.txt
#}
#
...
#		mkenvimage -s 0x80000 -o "${WORKDIR}/uboot.env" ${WORKDIR}/sdmmc_u-boot-env.txt
...
## TODO rm, disable u-boot environment, we use the .h approach    
#do_deploy(){
